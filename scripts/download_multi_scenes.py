...
SCENE_CATALOGUE = [
    # ── Batch 1: Original 10 scenes ───────────────────────────────────────────
    {
        "id": "SCENE_001",
        "description": "Rajasthan Desert — Thar (arid, sandy terrain)",
        "wrs_path": 148, "wrs_row": 41,
        "start_date": "2023-10-01", "end_date": "2024-03-31",
    },
    {
        "id": "SCENE_002",
        "description": "Delhi NCR — Dense urban heat island",
        "wrs_path": 146, "wrs_row": 40,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_003",
        "description": "Kerala Coast — Tropical, coastal, high vegetation",
        "wrs_path": 144, "wrs_row": 54,
        "start_date": "2023-01-01", "end_date": "2023-04-30",
    },
    {
        "id": "SCENE_004",
        "description": "Gangetic Plains (UP/Bihar) — Agricultural flatlands",
        "wrs_path": 147, "wrs_row": 41,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_005",
        "description": "Himalayan Foothills (Uttarakhand) — Snow + forest",
        "wrs_path": 147, "wrs_row": 38,
        "start_date": "2023-02-01", "end_date": "2023-05-31",
    },
    {
        "id": "SCENE_006",
        "description": "Mumbai Metropolitan — Coastal urban, water bodies",
        "wrs_path": 148, "wrs_row": 47,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_007",
        "description": "Deccan Plateau (Telangana) — Semi-arid, mixed crops",
        "wrs_path": 144, "wrs_row": 47,
        "start_date": "2023-01-01", "end_date": "2023-04-30",
    },
    {
        "id": "SCENE_008",
        "description": "Sundarbans (WB) — Mangrove + tidal rivers",
        "wrs_path": 138, "wrs_row": 44,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_009",
        "description": "Rann of Kutch — Salt flats + coastal wetlands",
        "wrs_path": 150, "wrs_row": 43,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_010",
        "description": "Kaziranga / Brahmaputra (Assam) — Floodplains + grassland",
        "wrs_path": 136, "wrs_row": 42,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    # ── Batch 2: Additional 10 scenes (diverse terrain) ───────────────────────
    {
        "id": "SCENE_011",
        "description": "Ladakh — High-altitude cold desert, glaciers",
        "wrs_path": 148, "wrs_row": 36,
        "start_date": "2023-07-01", "end_date": "2023-10-31",
    },
    {
        "id": "SCENE_012",
        "description": "Chilika Lake (Odisha) — Largest coastal lagoon in India",
        "wrs_path": 141, "wrs_row": 46,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_013",
        "description": "Chambal Valley (MP) — Ravines and river",
        "wrs_path": 146, "wrs_row": 43,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_014",
        "description": "Chennai Metro — Coastal city, urban+sea",
        "wrs_path": 142, "wrs_row": 52,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_015",
        "description": "Sikkim Himalayas — High mountain + snow + forest",
        "wrs_path": 139, "wrs_row": 41,
        "start_date": "2023-03-01", "end_date": "2023-06-30",
    },
    {
        "id": "SCENE_016",
        "description": "Andaman Islands — Tropical island + ocean",
        "wrs_path": 131, "wrs_row": 53,
        "start_date": "2023-01-01", "end_date": "2023-05-31",
    },
    {
        "id": "SCENE_017",
        "description": "Vidarbha (Maharashtra) — Cotton belt, semi-arid",
        "wrs_path": 145, "wrs_row": 46,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_018",
        "description": "Lakshadweep — Coral island + turquoise ocean",
        "wrs_path": 143, "wrs_row": 60,
        "start_date": "2023-01-01", "end_date": "2023-05-31",
    },
    {
        "id": "SCENE_019",
        "description": "Jharkhand Mining Belt — Forest + open cast mines",
        "wrs_path": 140, "wrs_row": 44,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_020",
        "description": "Punjab Croplands — Dense irrigated wheat fields",
        "wrs_path": 148, "wrs_row": 38,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    # ── Batch 3: Another 10 diverse scenes ────────────────────────────────────
    {
        "id": "SCENE_021",
        "description": "Goa — Coastal beaches + forest + urban",
        "wrs_path": 147, "wrs_row": 48,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_022",
        "description": "Spiti Valley — Extreme altitude cold desert",
        "wrs_path": 147, "wrs_row": 37,
        "start_date": "2023-06-01", "end_date": "2023-10-31",
    },
    {
        "id": "SCENE_023",
        "description": "Kolkata Urban — Dense riverine megacity",
        "wrs_path": 138, "wrs_row": 44,
        "start_date": "2024-01-01", "end_date": "2024-04-30",
    },
    {
        "id": "SCENE_024",
        "description": "Panna Tiger Reserve — Dry deciduous forest + river",
        "wrs_path": 144, "wrs_row": 44,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_025",
        "description": "Bhuj / Kutch District — Semi-arid shrubland",
        "wrs_path": 151, "wrs_row": 43,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_026",
        "description": "Godavari Delta (AP) — River delta + rice paddies",
        "wrs_path": 141, "wrs_row": 49,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_027",
        "description": "Western Ghats (Karnataka) — Dense evergreen forest",
        "wrs_path": 145, "wrs_row": 51,
        "start_date": "2023-01-01", "end_date": "2023-04-30",
    },
    {
        "id": "SCENE_028",
        "description": "Barmer (Rajasthan) — Oil fields + arid desert",
        "wrs_path": 150, "wrs_row": 42,
        "start_date": "2023-10-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_029",
        "description": "Bhopal Region — Mixed forest + reservoir + urban",
        "wrs_path": 145, "wrs_row": 44,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_030",
        "description": "Northeast India (Manipur) — Hilly tribal terrain",
        "wrs_path": 134, "wrs_row": 43,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    # ── Batch 4: Final 20 scenes to reach 50 ─────────────────────────────────
    {
        "id": "SCENE_031",
        "description": "Jaisalmer — Sand dunes, sparse vegetation",
        "wrs_path": 150, "wrs_row": 41,
        "start_date": "2023-10-01", "end_date": "2024-03-31",
    },
    {
        "id": "SCENE_032",
        "description": "Hyderabad Metro — Deccan urban sprawl + lakes",
        "wrs_path": 144, "wrs_row": 48,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_033",
        "description": "Coromandel Coast (TN) — Flat coastal plain",
        "wrs_path": 142, "wrs_row": 53,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_034",
        "description": "Bastar Forest (CG) — Dense sal forest + tribal",
        "wrs_path": 142, "wrs_row": 46,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_035",
        "description": "Narmada Valley — River + reservoir + agriculture",
        "wrs_path": 146, "wrs_row": 45,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_036",
        "description": "Aravalli Range — Rocky hills + scrub forest",
        "wrs_path": 148, "wrs_row": 43,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_037",
        "description": "Cauvery Delta (TN) — Intensive rice cultivation",
        "wrs_path": 142, "wrs_row": 54,
        "start_date": "2023-01-01", "end_date": "2023-04-30",
    },
    {
        "id": "SCENE_038",
        "description": "Meghalaya — Wettest place on earth, dense cloud forest",
        "wrs_path": 136, "wrs_row": 43,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_039",
        "description": "Bangalore — IT hub, urban lake + greenery",
        "wrs_path": 144, "wrs_row": 51,
        "start_date": "2023-01-01", "end_date": "2023-04-30",
    },
    {
        "id": "SCENE_040",
        "description": "Alappuzha (Kerala) — Backwaters + paddy fields",
        "wrs_path": 144, "wrs_row": 55,
        "start_date": "2023-01-01", "end_date": "2023-04-30",
    },
    {
        "id": "SCENE_041",
        "description": "Thar Desert South — Barmer/Jodhpur transition zone",
        "wrs_path": 149, "wrs_row": 42,
        "start_date": "2023-10-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_042",
        "description": "Dibang Valley (Arunachal) — Pristine Himalayan valley",
        "wrs_path": 133, "wrs_row": 41,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_043",
        "description": "Bhavnagar (Gujarat) — Salt pans + tidal flats",
        "wrs_path": 149, "wrs_row": 45,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_044",
        "description": "Agra Region — Semi-arid, Yamuna river",
        "wrs_path": 146, "wrs_row": 42,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_045",
        "description": "Kutch Wetlands — Seasonal water bodies + flamingos",
        "wrs_path": 151, "wrs_row": 44,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_046",
        "description": "Puri Coast (Odisha) — Temple town + beach + agriculture",
        "wrs_path": 140, "wrs_row": 46,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_047",
        "description": "Amritsar — Irrigated plains near Pakistan border",
        "wrs_path": 148, "wrs_row": 37,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_048",
        "description": "Nagaland Hills — Terraced agriculture + dense forest",
        "wrs_path": 134, "wrs_row": 42,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_049",
        "description": "Visakhapatnam — Port city, hills + ocean + industrial",
        "wrs_path": 141, "wrs_row": 48,
        "start_date": "2023-11-01", "end_date": "2024-02-28",
    },
    {
        "id": "SCENE_050",
        "description": "Kochi — Port, backwaters, dense coastal urban",
        "wrs_path": 144, "wrs_row": 53,
        "start_date": "2023-01-01", "end_date": "2023-04-30",
    },
]
